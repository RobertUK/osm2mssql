...
CREATE DATABASE [OSM] ON  PRIMARY 
( NAME = N'osm', FILENAME = N'D:\tempdb\osm.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'osm_log', FILENAME = N'D:\tempdb\osm_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )

ALTER DATABASE [osm] ADD FILEGROUP [TEMP]
ALTER DATABASE [osm] ADD FILE ( NAME = N'osm_temp', FILENAME = N'D:\tempdb\osm_temp.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB ) TO FILEGROUP [TEMP]
